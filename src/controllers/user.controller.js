...
//we want to get user channel profile
...
const UserWatchHistory = asynchandler(async (req , res) =>{
    ...
    .json(
        new ApiResponse(
            200,
            user[0].watchhistory,
            "Watch history fetched sucessfull"
        )
    )
})


export {registerUser , loginUser , logoutUser , generateTokens , ChangePassword , getCurrentUser , updateAccountDetail , updateAvatar , updateCoverImage , getUserChannelProfile , UserWatchHistory};